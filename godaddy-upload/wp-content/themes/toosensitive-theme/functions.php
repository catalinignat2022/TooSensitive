...
function toosensitive_scripts() {
    ...
    // Main stylesheet
    wp_enqueue_style('toosensitive-style', get_stylesheet_uri(), array(), $version);
    
    // Custom CSS
    wp_enqueue_style('toosensitive-custom', get_template_directory_uri() . '/assets/css/custom.css', array('toosensitive-style'), $version);
    
    // RSD Authentication System CSS
    wp_enqueue_style('rsd-auth-system', get_template_directory_uri() . '/assets/css/rsd-auth-system.css', array('toosensitive-style'), $version);
    
    // Main JavaScript
    wp_enqueue_script('toosensitive-main', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), $version, true);
    
    // RSD Authentication System JavaScript
    wp_enqueue_script('rsd-auth-system', get_template_directory_uri() . '/assets/js/rsd-auth-system.js', array('jquery'), $version, true);
    ...
    wp_localize_script('toosensitive-main', 'toosensitive_ajax', array(
        ...
        'strings' => array(
            'loading' => __('Loading...', 'toosensitive'),
            'error' => __('An error occurred. Please try again.', 'toosensitive'),
            'success' => __('Success!', 'toosensitive'),
        )
    ));
